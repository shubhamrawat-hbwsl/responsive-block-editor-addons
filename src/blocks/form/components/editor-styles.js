...
function EditorStyles(props) {
  ...
  var selectors = {
    ...
    " .responsive-block-editor-addons-form-input__text": {
      "padding-top": generateCSSUnit(inputFieldTopPadding, 'px'),
      "padding-bottom": generateCSSUnit(inputFieldBottomPadding, 'px'),
      "padding-left": generateCSSUnit(inputFieldLeftPadding, 'px'),
      "padding-right": generateCSSUnit(inputFieldRightPadding, 'px'),
    },
  ...
  var mobile_selectors = {
    ...
    " .responsive-block-editor-addons-form-input__text": {
      "padding-top": generateCSSUnit(inputFieldTopPaddingMobile, 'px'),
      "padding-bottom": generateCSSUnit(inputFieldBottomPaddingMobile, 'px'),
      "padding-left": generateCSSUnit(inputFieldLeftPaddingMobile, 'px'),
      "padding-right": generateCSSUnit(inputFieldRightPaddingMobile, 'px'),
    },
    " .responsive-block-editor-addons-form-submit-button-container": {
  ...
  var tablet_selectors = {
    ...
    " .responsive-block-editor-addons-form-input__text": {
      "padding-top": generateCSSUnit(inputFieldTopPaddingTablet, 'px'),
      "padding-bottom": generateCSSUnit(inputFieldBottomPaddingTablet, 'px'),
      "padding-left": generateCSSUnit(inputFieldLeftPaddingTablet, 'px'),
      "padding-right": generateCSSUnit(inputFieldRightPaddingTablet, 'px'),
    },
    " .responsive-block-editor-addons-form-submit-button-container": {
